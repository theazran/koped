...
function commandArray() {
    let hasil = [prefix+'daftar',prefix+'chord',prefix+'nulis', prefix+'nulis2',prefix+'menu',prefix+'help', prefix+'sticker', prefix+'stiker', prefix+'creator','#bot restart',prefix+'tiktok',prefix+'translate',prefix+'qrcode',prefix+'leave','#bot block','#bot unblock',prefix+'simsimi help',prefix+'lirik',prefix+'nhinfo',
prefix+'ig',prefix+'instagram',prefix+'twt',prefix+'twitter', prefix+'halo', prefix+'about', prefix+'speed',prefix+'ping', prefix+'fb',prefix+'facebook',prefix+'yt',prefix+'gtts',prefix+'tts','@6289654471026',prefix+'qnime',prefix+'simsimi stop',prefix+'adult zone',prefix+'everyone',
...
prefix+'banchat on',prefix+'banchat off','#mtc start','#mtc stop','#bc','Assalamualaikum',"Assalamu'alaikum",'Samlikum','#donasi','!donasi',prefix+'join',prefix+'limit',prefix+'help 2',prefix+'menu 2',prefix+'bug report',prefix+'activate','#whitelist add']
    return hasil
}
...
Hai!, 
berikut adalah *MENU* yang terdapat pada *BOT KOPED*

GROUP
https://chat.whatsapp.com/JMdcOM9pMDLLlkDYBiESLy

*BOT*
┏◉ *!info*
┣◉ *!mnt* Syarat dan ketentuan
┣◉ *!limit*
┣◉ *!donasi*
┣◉ *!daftar* Join Premium
┣◉ *!speed*
...
*MALAS NULIS*
┏◉ *!nulis [tulisan kamu]* SIDU
┣◉ *!nulis2 [tulisan kamu]* HVS
┗◉ *!nulis3* _cooming soon_

*NGAJI*
┏◉ *!list surah*
┣◉ *!surah [nomor surah]* _info_
┣◉ *!surah [nomor surah] ayat 10*
┣◉ *!surah [nomor surah] ayat 10-12*
┣◉ *!surah [nomor surah] ayat 10,15,20*
┗◉ *!quran* _ayat random AL-Qur'an_
...
┣◉ *!kucing*
┣◉ *!wait*
┣◉ *!compress [kirim/reply gambar]*
┣◉ *!wallpaper*
┣◉ *!corona*
┣◉ *!corona prov [nama provinsi]*
┣◉ *!cekresi [no resi] [kurir]*
┣◉ *!gtts [teks]*
┣◉ *!tts [kode bahasa] [teks]*
┣◉ *!bahasa*_lihat kode bahasa_
┣◉ *!igstalk [username]*
┣◉ *!qrcode*
┣◉ *!translate [kode bahasa] [tekt]*
┣◉ *!delete*
┣◉ *!lirik*
┣◉ *!join [linkgroup]*
┗◉ *!adult zone* +18
...
// function help() {
//     let hasil = `~ ~>  *BOT KOPED Help*  <~ ~
// -------------------------------------------------------------------
// Ada masalah? laporkan masalah dengan :
// ~> *!bug report [deskripsi]* nulis woi
// -------------------------------------------------------------------
// Nomor BOT XyZ!
// ~> *wa.me/6289654471026*
// -------------------------------------------------------------------
...
// exports.help2 = help2()
function license(){
    return `Syarat dan Ketentuan BOT KOPED\n
